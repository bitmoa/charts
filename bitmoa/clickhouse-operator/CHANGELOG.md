...
* Bump `clickhouse-keeper` image to `26.8.12-debian-12-r0` (was `26.8.11-debian-12-r0`)

## 0.4.1 (2026-09-26)

* Bump `clickhouse` image to `26.8.11-debian-12-r1` (was `26.8.10-debian-12-r1`)

## 0.4.0 (2026-09-24)

* Bump `clickhouse-operator-metrics-exporter` image to `0.27.4-debian-12-r0` (was `0.27.3-debian-12-r4`)
...
* Bump `clickhouse-keeper` image to `26.8.6-debian-12-r0` (was `26.8.4-debian-12-r0`)
