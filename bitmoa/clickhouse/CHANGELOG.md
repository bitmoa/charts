...
* Bump `clickhouse-keeper` image to `26.8.12-debian-12-r0` (was `26.8.11-debian-12-r1`)
...
* Bump `clickhouse` image to `26.8.10-debian-12-r1` (was `26.8.10-debian-12-r0`)

## 9.11.0 (2026-09-22)

* Bump `clickhouse-keeper` image to `26.8.11-debian-12-r0` (was `26.8.10-debian-12-r0`)

## 9.10.0 (2026-09-22)

* Bump `clickhouse` image to `26.8.10-debian-12-r0` (was `26.8.8-debian-12-r2`)

## 9.9.4 (2026-09-22)

* Bump `clickhouse-keeper` image to `26.8.10-debian-12-r0` (was `26.8.9-debian-12-r0`)

## 9.9.3 (2026-09-20)

* Bump `clickhouse` image to `26.8.8-debian-12-r2` (was `26.8.8-debian-12-r1`)
...
* Bump `clickhouse` image to `26.8.8-debian-12-r0` (was `26.8.6-debian-12-r2`)

## 9.8.3 (2026-09-18)

* Bump `clickhouse` image to `26.8.6-debian-12-r2` (was `26.8.7-debian-12-r0`)
...
* Bump `clickhouse-keeper` image to `26.8.6-debian-12-r0` (was `26.8.5-debian-12-r0`)

## 9.7.1 (2026-09-15)

* Bump `clickhouse` image to `26.8.5-debian-12-r0` (was `26.8.4-debian-12-r1`)

## 9.7.0 (2026-09-15)

* Bump `clickhouse-keeper` image to `26.8.5-debian-12-r0` (was `26.8.4-debian-12-r0`)

## 9.6.1 (2026-09-15)

* Bump `clickhouse` image to `26.8.4-debian-12-r1` (was `25.7.5-debian-12-r0`)

## 9.6.0 (2026-09-15)

* Bump `clickhouse-keeper` image to `26.8.4-debian-12-r0` (was `26.8.3-debian-12-r0`)
...
* [bitnami/clickhouse] feat: :sparkles: :lock: Add resource preset support (#23436) ([0a82ef6](https://github.com/bitnami/charts/commit/0a82ef66b9840ffb6b9063045397bf95ebe1a67d)), closes [#23436](https://github.com/bitnami/charts/issues/23436)
...
* [bitnami/clickhouse] feat: :sparkles: Add support for PSA restricted policy (#20408) ([b0cc870](https://github.com/bitnami/charts/commit/b0cc87042f41b572d21e786058fef25aa585cd54)), closes [#20408](https://github.com/bitnami/charts/issues/20408)
...
* [bitnami/clickhouse] Release 3.6.6 (#18504) ([bf7d550](https://github.com/bitnami/charts/commit/bf7d550b360e2a97782b204ff39ccb6551d3676f)), closes [#18504](https://github.com/bitnami/charts/issues/18504)
...
* [bitnami/clickhouse] fix: typo in variable reference (#15528) ([087462a](https://github.com/bitnami/charts/commit/087462a68d8705664e059bd2e61fca1c4439749e)), closes [#15528](https://github.com/bitnami/charts/issues/15528)
...
* [bitnami/clickhouse] Release 2.1.1 (#13982) ([18bc449](https://github.com/bitnami/charts/commit/18bc449e39366737f8e14940e88b2a67dbc268d0)), closes [#13982](https://github.com/bitnami/charts/issues/13982)
