...
* Bump `redis` image to `8.10.2-debian-12-r1` (was `8.10.2-debian-12-r0`)

## 22.2.4 (2026-09-26)

* Bump `redis-sentinel` image to `8.10.2-debian-12-r1` (was `8.10.2-debian-12-r0`)
...
* Bump `redis` image to `8.10.2-debian-12-r0` (was `8.10.1-debian-12-r1`)
...
* Bump `redis-sentinel` image to `8.10.1-debian-12-r1` (was `8.2.1-debian-12-r0`)
